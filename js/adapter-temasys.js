/*! adapterjs - v0.13.4 - 2017-03-09 */

// BEGIN LS EDIT: this file has been modified slightly to pass our linting and tests
/* eslint-disable */
// define global variables to avoid implicit creation
var __TemWebRTCReady0,
  attachMediaStream,
...
AdapterJS.WebRTCPlugin.pluginInfo = {
  prefix : 'LS',
  plugName : 'LSWebRTCPlugin',
  pluginId : 'plugin0',
  type : 'application/x-lswebrtcplugin',
  onload : '__TemWebRTCReady0',
  portalLink : null,
  downloadLink : null, //set below
  companyName: 'Lifesize'
};
if(!!navigator.platform.match(/^Mac/i)) {
  AdapterJS.WebRTCPlugin.pluginInfo.downloadLink = 'http://bit.ly/1A0XVYJ';
}
else if(!!navigator.platform.match(/^Win/i)) {
  AdapterJS.WebRTCPlugin.pluginInfo.downloadLink = 'https://temasys-cdn.s3.amazonaws.com/plugin/lifesize/1.0.22/LSWebRTCPlugin.msi.zip';
}
